            ...
            <form class="formulaire" id="form" action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="user-info">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="email" id="email" placeholder="Entrez votre Email..." value="">
                    </div>
                    <div class="input-wrapper">
                        <label for="matricule">Matricule</label>
                        <input type="text" name="matricule" id="matricule" placeholder="Entrez votre Matricule..." value="">
                    </div>
                    <div class="input-wrapper">
                ...
                <button type="submit" class="btnSubmit" name="submit" id="submit">Confirmer</button>
            </form>
        </div>
